...
<%
    ...
    List<Product> products = prc.getProductsByCategory("cables");
...
<html>
    <head>
        ...
        <title>Ciscoware Cables Overhead</title>
    ...
    <center>
        <div class="shop-menu">
            ...
            <button class="active-shop-btn" onclick="location.href = 'cables/cables-overhead.jsp';">Cables</button>
        </div>
    </center>
    <div class="nav-shop-item">
        <p class="shop-title">Cables</p>
        <img src="../img/shop/cabling.png" class="shop-picture" alt=""/>
        <a href="cables-utp.jsp" class="shop-link">Unshielded Twisted Pair Cable</a>
        <a href="cables-stp.jsp" class="shop-link">Shielded Twisted Pair Cable</a>
        <a href="cables-coxial.jsp" class="shop-link marg-b-88">Coxial cable</a>
    </div>
